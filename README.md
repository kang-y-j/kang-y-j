...
- KT Aivle School 6기 (AI Track)  
- 빅데이터 분석기사 — 2025 상반기 예정  
- 정보처리기사 — 2025 상반기 예정

---

# Projects  
아래 프로젝트들은 최근 3~6주 동안 진행한 학습 및 구현 기반 작업입니다.  
각 Repository는 단계적으로 업데이트될 예정입니다.

---

## 1) AI Interview Agent (LangGraph 기반)
...
- **Highlights**
  - 슬라이드 단위 상태(State) 관리
  - 텍스트 + 이미지 멀티모달 입력 처리
  - 단계별 파이프라인을 LangGraph로 구성

👉 프로젝트 상세: `ppt-lecture-agent/README.md`
...
👉 프로젝트 상세: `ai-interviewer-agent/README.md`
...
👉 프로젝트 상세: `ai-book-management/README.md`

---

## 4) RAG 기반 문서 질의응답 시스템
> 문서 데이터를 임베딩하여 저장하고  
> 사용자의 질문에 대해 근거 기반 답변을 제공하는 RAG 시스템

- **Category**: RAG / NLP
- **Tech**: Python, LangChain, OpenAI Embedding API, FAISS
- **Highlights**
  - 문서 분할(chunking) 및 전처리 파이프라인 설계
  - 임베딩 생성 및 벡터 검색 기반 문서 검색 구현
  - 검색 결과를 활용한 LLM 응답 생성 흐름 구성
  - LLM hallucination 최소화를 위한 컨텍스트 제한 전략 적용

👉 프로젝트 상세: `rag-qa-system/README.md`
