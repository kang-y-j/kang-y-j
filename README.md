...
LangChain과 Python 중심으로 LLM 기반 서비스 흐름을 설계하고 구현해본 경험이 있습니다. 
...
<div style="display: flex; gap: 20px; width: 100%;">
  ...
  <div style="flex: 1;">
    ...
    <table>
      ...
      <tr>
        <td><b>ML / 데이터</b></td>
        <td>NumPy, Pandas, Scikit-learn(기초), 데이터 전처리 및 EDA</td>
      </tr>
      <tr>
        <td><b>LLM 파이프라인</b></td>
        <td>LangChain 기반 LLM 파이프라인 구성</td>
      </tr>
      <tr>
        <td><b>RAG 구성</b></td>
        <td>문서 임베딩 생성(OpenAI), 검색 기반 RAG 구조 설계</td>
      </tr>
      <tr>
        <td><b>개발 환경</b></td>
        <td>Git, GitHub, Colab, Jupyter</td>
      </tr>
    </table>
  </div>
  ...
  <div style="flex: 1;">
    ...
    <p><i>학습 및 실습을 통해 확장 중인 기술 영역</i></p>
    <table>
      <tr><th>분야</th><th>기술</th></tr>
      <tr>
        <td><b>Backend (REST API)</b></td>
        <td>FastAPI, Spring Boot (모델 추론 API 구성 및 연동 경험)</td>
      </tr>
      <tr>
      ...
      <tr>
        <td><b>배포 / 환경</b></td>
        <td>Docker, 간단한 클라우드 배포</td>
      </tr>
      <tr>
        <td><b>MLOps</b></td>
        <td>모델 서빙, 파이프라인 자동화</td>
      </tr>
      <tr>
        <td><b>DB 기초</b></td>
        <td>SQL</td>
...
아래 프로젝트들은 학습 및 실습 목적의 프로젝트로,
각각 특정 기능이나 구조에 초점을 두고 구현했습니다.
모든 기능을 완전 자동화하거나 상용 수준으로 구현한 것은 아닙니다.
...
👉 프로젝트 상세:[Multimodal Lecture Agent](https://github.com/kang-y-j/multimodal-lecture-agent)

---
## 3) EV Charger Ops Platform - 진행 중
> 현재 센서 데이터 기반 이상 탐지 파이프라인을 설계·구현 중이며,
> 운영 시나리오를 고려한 판단 로직을 고도화하고 있습니다.
## 3) EV Charger Ops Platform - 전기차 충전소 통합 관제 시스템

> 센서 데이터와 이미지를 AI로 분석해 충전기 이상을 감지하고,
> 운영자에게 자동 알림을 발송하는 충전소 관리 플랫폼

- **Category**: AI Integration / Backend / Monitoring
- **Tech**: Spring Boot, FastAPI, LangChain, LightGBM, WebClient, AWS S3, JPA
- **Team**: 8명 / 담당: Backend (로그인), AI 모델 개발
- **Highlights**
